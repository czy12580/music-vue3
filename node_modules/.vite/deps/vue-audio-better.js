      ...
      return function(e) {
          ...
          for (var t2 = 0; t2 < e2.length; t2++) {
            ...
            if (o2) {
              ...
              for (; r2 < n2.parts.length; r2++)
                o2.parts.push(i(n2.parts[r2]));
              o2.parts.length > n2.parts.length && (o2.parts.length = n2.parts.length);
            } else {
              for (var a2 = [], r2 = 0; r2 < n2.parts.length; r2++)
                a2.push(i(n2.parts[r2]));
        ...
        function i(e2) {
          ...
          if (g) {
            ...
            o2 = r(), t2 = s.bind(null, o2), n2 = function() {
              o2.parentNode.removeChild(o2);
            };
          return t2(e2), function(o3) {
            if (o3) {
              if (o3.css === e2.css && o3.media === e2.media && o3.sourceMap === e2.sourceMap)
                return;
              t2(e2 = o3);
            } else
              n2();
        ...
        function s(e2, t2) {
          ...
          if (o2 && e2.setAttribute("media", o2), m.ssrId && e2.setAttribute(v, t2.id), r2 && (n2 += "\n/*# sourceURL=" + r2.sources[0] + " */", n2 += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(r2)))) + " */"), e2.styleSheet)
        ...
        t.a = { props: { audioSource: { type: String, required: true, validator: function(e2) {
          ...
          if ("number" != typeof e2)
            throw new Error("volume must be a number, got a " + (void 0 === e2 ? "undefined" : l(e2)) + " instead");
          this.$data._howl.volume(i()(e2, 0, 1));
        }, setRate: function(e2) {
          if ("number" != typeof e2)
            throw new Error("rate must be a number, got a " + (void 0 === e2 ? "undefined" : l(e2)) + " instead");
          this.$data._howl.rate(i()(e2, 0.5, 4));
        }, setSeek: function(e2) {
          if ("number" != typeof e2)
            throw new Error("seek must be a number, got a " + (void 0 === e2 ? "undefined" : l(e2)) + " instead");
          this.$data._howl.seek(i()(e2, 0, this.duration));
        }, setProgress: function(e2) {
          if ("number" != typeof e2)
            throw new Error("progress must be a number, got a " + (void 0 === e2 ? "undefined" : l(e2)) + " instead");
          ...
          !function() {
            ...
            i.prototype = { init: function() {
              ...
              if (e2 = parseFloat(e2), t2.ctx || _(), void 0 !== e2 && e2 >= 0 && e2 <= 1) {
                if (t2._volume = e2, t2._muted)
                  return t2;
                t2.usingWebAudio && t2.masterGain.gain.setValueAtTime(e2, a.ctx.currentTime);
                for (var n3 = 0; n3 < t2._howls.length; n3++)
                  if (!t2._howls[n3]._webAudio)
                    for (var o2 = t2._howls[n3]._getSoundIds(), r2 = 0; r2 < o2.length; r2++) {
              ...
              for (var e2 = this || a, t2 = e2._howls.length - 1; t2 >= 0; t2--)
                e2._howls[t2].unload();
              ...
              if (!t2 || "function" != typeof t2.canPlayType)
                return e2;
              ...
              if (!e2._audioUnlocked && e2.ctx) {
                ...
                var t2 = function(n3) {
                  for (var o2 = 0; o2 < e2.html5PoolSize; o2++)
                    try {
                      var r2 = new Audio();
                  ...
                  for (var o2 = 0; o2 < e2._howls.length; o2++)
                    if (!e2._howls[o2]._webAudio)
                      for (var i2 = e2._howls[o2]._getSoundIds(), a2 = 0; a2 < i2.length; a2++) {
                  ...
                  u2.buffer = e2._scratchBuffer, u2.connect(e2.ctx.destination), void 0 === u2.start ? u2.noteOn(0) : u2.start(0), "function" == typeof e2.ctx.resume && e2.ctx.resume(), u2.onended = function() {
                    ...
                    for (var n4 = 0; n4 < e2._howls.length; n4++)
                      e2._howls[n4]._emit("unlock");
                  };
                };
              ...
              if (e2.autoSuspend && e2.ctx && void 0 !== e2.ctx.suspend && a.usingWebAudio) {
                for (var t2 = 0; t2 < e2._howls.length; t2++)
                  if (e2._howls[t2]._webAudio) {
                    for (var n3 = 0; n3 < e2._howls[t2]._sounds.length; n3++)
                      if (!e2._howls[t2]._sounds[n3]._paused)
                        return e2;
                  }
              ...
              var e2 = this;
              if (e2.ctx && void 0 !== e2.ctx.resume && a.usingWebAudio)
                return "running" === e2.state && e2._suspendTimer ? (clearTimeout(e2._suspendTimer), e2._suspendTimer = null) : "suspended" === e2.state ? (e2.ctx.resume().then(function() {
                  e2.state = "running";
                  for (var t2 = 0; t2 < e2._howls.length; t2++)
                    e2._howls[t2]._emit("resume");
            ...
            s.prototype = { init: function(e2) {
              ...
              if ("number" == typeof e2)
                ...
                if ("string" == typeof e2 && "loaded" === n3._state && !n3._sprite[e2])
                  return null;
                if (void 0 === e2 && (e2 = "__default", !n3._playLock)) {
                  for (var r2 = 0, i2 = 0; i2 < n3._sounds.length; i2++)
                    n3._sounds[i2]._paused && !n3._sounds[i2]._ended && (r2++, o2 = n3._sounds[i2]._id);
              ...
              if (o2 && !s2._paused)
                return t2 || n3._loadQueue("play"), s2._id;
              ...
              if (n3._webAudio) {
                ...
                var g = function() {
                  ...
                  try {
                    ...
                    })) : t2 || (n3._playLock = false, h(), n3._emit("play", s2._id), n3._loadQueue()), m.playbackRate = s2._rate, m.paused)
                      return void n3._emit("playerror", s2._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
              ...
              if ("loaded" !== t2._state || t2._playLock)
                return t2._queue.push({ event: "pause", action: function() {
                  t2.pause(e2);
                } }), t2;
              for (var n3 = t2._getSoundIds(e2), o2 = 0; o2 < n3.length; o2++) {
                t2._clearTimer(n3[o2]);
                var r2 = t2._soundById(n3[o2]);
                if (r2 && !r2._paused && (r2._seek = t2.seek(n3[o2]), r2._rateSeek = 0, r2._paused = true, t2._stopFade(n3[o2]), r2._node))
                  if (t2._webAudio) {
              ...
              var n3 = this;
              if ("loaded" !== n3._state || n3._playLock)
              ...
              if (1 === o2.length || 2 === o2.length && void 0 === o2[1]) {
                ...
                o2.length >= 2 && (e2 = parseFloat(o2[0]), t2 = parseInt(o2[1], 10));
              var r2;
              if (!(void 0 !== e2 && e2 >= 0 && e2 <= 1))
                return r2 = t2 ? n3._soundById(t2) : n3._sounds[0], r2 ? r2._volume : 0;
              if ("loaded" !== n3._state || n3._playLock)
                return n3._queue.push({ event: "volume", action: function() {
                  n3.volume.apply(n3, o2);
                } }), n3;
              void 0 === t2 && (n3._volume = e2), t2 = n3._getSoundIds(t2);
              for (var i2 = 0; i2 < t2.length; i2++)
                (r2 = n3._soundById(t2[i2])) && (r2._volume = e2, o2[2] || n3._stopFade(t2[i2]), n3._webAudio && r2._node && !r2._muted ? r2._node.gain.setValueAtTime(e2, a.ctx.currentTime) : r2._node && !r2._muted && (r2._node.volume = e2 * a.volume()), n3._emit("volume", r2._id));
              return n3;
            }, fade: function(e2, t2, n3, o2) {
              var r2 = this;
              if ("loaded" !== r2._state || r2._playLock)
              ...
              if (1 === r2.length) {
                if ("boolean" != typeof r2[0])
                  return !!(n3 = o2._soundById(parseInt(r2[0], 10))) && n3._loop;
                e2 = r2[0], o2._loop = e2;
              } else
                2 === r2.length && (e2 = r2[0], t2 = parseInt(r2[1], 10));
              for (var i2 = o2._getSoundIds(t2), a2 = 0; a2 < i2.length; a2++)
                (n3 = o2._soundById(i2[a2])) && (n3._loop = e2, o2._webAudio && n3._node && n3._node.bufferSource && (n3._node.bufferSource.loop = e2, e2 && (n3._node.bufferSource.loopStart = n3._start || 0, n3._node.bufferSource.loopEnd = n3._stop)));
              return o2;
            }, rate: function() {
              var e2, t2, n3 = this, o2 = arguments;
              if (0 === o2.length)
                ...
                2 === o2.length && (e2 = parseFloat(o2[0]), t2 = parseInt(o2[1], 10));
              var s2;
              if ("number" != typeof e2)
                return s2 = n3._soundById(t2), s2 ? s2._rate : n3._rate;
              if ("loaded" !== n3._state || n3._playLock)
                return n3._queue.push({ event: "rate", action: function() {
                  n3.rate.apply(n3, o2);
                } }), n3;
              void 0 === t2 && (n3._rate = e2), t2 = n3._getSoundIds(t2);
              for (var u2 = 0; u2 < t2.length; u2++)
                if (s2 = n3._soundById(t2[u2])) {
              ...
              for (var o2 = 0; o2 < t2._sounds.length; o2++)
                if (!t2._sounds[o2]._paused)
                  return true;
              return false;
              ...
              for (var e2 = this, t2 = e2._sounds, n3 = 0; n3 < t2.length; n3++)
                t2[n3]._paused || e2.stop(t2[n3]._id), e2._webAudio || (e2._clearSound(t2[n3]._node), t2[n3]._node.removeEventListener("error", t2[n3]._errorFn, false), t2[n3]._node.removeEventListener(a._canPlayEvent, t2[n3]._loadFn, false), a._releaseHtml5Audio(t2[n3]._node)), delete t2[n3]._node, e2._clearTimer(t2[n3]._id);
              var o2 = a._howls.indexOf(e2);
              o2 >= 0 && a._howls.splice(o2, 1);
              var r2 = true;
              for (n3 = 0; n3 < a._howls.length; n3++)
                if (a._howls[n3]._src === e2._src || e2._src.indexOf(a._howls[n3]._src) >= 0) {
                  r2 = false;
                  break;
                }
              ...
              if ("number" == typeof t2 && (n3 = t2, t2 = null), t2 || n3)
                ...
                for (i2 = 0; i2 < s2.length; i2++)
                  0 === s2[i2].indexOf("_on") && Array.isArray(o2[s2[i2]]) && (o2[s2[i2]] = []);
              }
              return o2;
              ...
              for (var o2 = this, r2 = o2["_on" + e2], i2 = r2.length - 1; i2 >= 0; i2--)
                r2[i2].id && r2[i2].id !== t2 && "load" !== e2 || (setTimeout(function(e3) {
                  e3.call(this, t2, n3);
              ...
              if (!t2._webAudio && e2._node && !e2._node.paused && !e2._node.ended && e2._node.currentTime < e2._stop)
                return setTimeout(t2._ended.bind(t2, e2), 100), t2;
              ...
              var t2 = this;
              if (t2._endTimers[e2]) {
                if ("function" != typeof t2._endTimers[e2])
                  clearTimeout(t2._endTimers[e2]);
                else {
                  var n3 = t2._soundById(e2);
              ...
              for (var t2 = this, n3 = 0; n3 < t2._sounds.length; n3++)
                if (e2 === t2._sounds[n3]._id)
                  return t2._sounds[n3];
              return null;
            }, _inactiveSound: function() {
              var e2 = this;
              e2._drain();
              for (var t2 = 0; t2 < e2._sounds.length; t2++)
                if (e2._sounds[t2]._ended)
                  return e2._sounds[t2].reset();
              return new u(e2);
            }, _drain: function() {
              var e2 = this, t2 = e2._pool, n3 = 0, o2 = 0;
              if (!(e2._sounds.length < t2)) {
                for (o2 = 0; o2 < e2._sounds.length; o2++)
                  e2._sounds[o2]._ended && n3++;
              ...
              var t2 = this;
              if (void 0 === e2) {
                for (var n3 = [], o2 = 0; o2 < t2._sounds.length; o2++)
                  n3.push(t2._sounds[o2]._id);
                return n3;
              }
              return [e2];
              ...
              if (a._scratchBuffer && e2.bufferSource && (e2.bufferSource.onended = null, e2.bufferSource.disconnect(0), n3))
                try {
            ...
            var d = {}, l = function(e2) {
              var t2 = e2._src;
              if (d[t2])
                return e2._duration = d[t2].duration, void p(e2);
              if (/^data:[^;]+;base64,/.test(t2)) {
                for (var n3 = atob(t2.split(",")[1]), o2 = new Uint8Array(n3.length), r2 = 0; r2 < n3.length; ++r2)
                  o2[r2] = n3.charCodeAt(r2);
                f(o2.buffer, e2);
              } else {
                ...
                i2.open("GET", t2, true), i2.withCredentials = e2._xhrWithCredentials, i2.responseType = "arraybuffer", i2.onload = function() {
                  var t3 = (i2.status + "")[0];
                  if ("0" !== t3 && "2" !== t3 && "3" !== t3)
                    return void e2._emit("loaderror", null, "Failed loading audio file with status: " + i2.status + ".");
                  f(i2.response, e2);
                }, i2.onerror = function() {
            ...
            HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(e3) {
              var t2 = this;
              if (!t2.ctx || !t2.ctx.listener)
                return t2;
              for (var n3 = t2._howls.length - 1; n3 >= 0; n3--)
                t2._howls[n3].stereo(e3);
              return t2;
            ...
            }, Howl.prototype.init = function(e3) {
              return function(t2) {
                var n3 = this;
              ...
              if (!o2._webAudio)
                return o2;
              if ("loaded" !== o2._state)
                return o2._queue.push({ event: "stereo", action: function() {
                  o2.stereo(t2, n3);
                } }), o2;
              ...
              if (1 === i.length) {
                if ("object" != typeof i[0])
                  return o2 = r2._soundById(parseInt(i[0], 10)), o2 ? o2._pannerAttr : r2._pannerAttr;
                ...
                2 === i.length && (t2 = i[0], n3 = parseInt(i[1], 10));
              for (var a = r2._getSoundIds(n3), s = 0; s < a.length; s++)
                if (o2 = r2._soundById(a[s])) {
              ...
              return r2;
            }, Sound.prototype.init = function(e3) {
              return function() {
            ...
            }(Sound.prototype.init), Sound.prototype.reset = function(e3) {
              return function() {
                var t2 = this, n3 = t2._parent;
        ...
        e.exports = function() {
          ...
          for (var n2, s, u = o(e2), d = 1; d < arguments.length; d++) {
            ...
            for (var l in n2)
              i.call(n2, l) && (u[l] = n2[l]);
            if (r) {
              s = r(n2);
              for (var c = 0; c < s.length; c++)
                a.call(n2, s[c]) && (u[s[c]] = n2[s[c]]);
            }
          }
          return u;
        };
...
// dep:vue-audio-better
var vue_audio_better_default = require_v_audio();
export {
  vue_audio_better_default as default
};
/*
object-assign
(c) Sindre Sorhus
